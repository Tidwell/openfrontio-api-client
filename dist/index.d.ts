...
type ZodStandardSchemaWithJSON$1<T> = StandardSchemaWithJSONProps<
  input<T>,
  output<T>
>;
...
type MakePartial<T, K extends keyof T> = Omit$1<T, K> &
...
interface $ZodString<Input = unknown> extends _$ZodType<
...
interface $ZodNumberInternals<Input = unknown> extends $ZodTypeInternals<
  number,
  Input
> {
  def: $ZodNumberDef;
...
interface $ZodBooleanInternals<T = unknown> extends $ZodTypeInternals<
  boolean,
  T
> {
  pattern: RegExp;
...
interface $ZodBigIntInternals<T = unknown> extends $ZodTypeInternals<
  bigint,
  T
> {
  pattern: RegExp;
...
interface $ZodUndefinedInternals extends $ZodTypeInternals<
  undefined,
  undefined
> {
  pattern: RegExp;
...
> extends _$ZodTypeInternals {
  ...
  isst:
    | $ZodIssueInvalidType
    | $ZodIssueTooBig<unknown[]>
    | $ZodIssueTooSmall<unknown[]>;
...
type $InferZodRecordInput<
  ...
  Value extends SomeType = $ZodType,
> = Key extends $partial
  ? Partial<Record<input<Key>, input<Value>>>
...
interface $ZodSetInternals<
  T extends SomeType = $ZodType,
> extends $ZodTypeInternals<Set<output<T>>, Set<input<T>>> {
  def: $ZodSetDef<T>;
  isst: $ZodIssueInvalidType;
  optin?: "optional" | undefined;
  optout?: "optional" | undefined;
...
interface $ZodEnumInternals<
  /** @ts-ignore Cast variance */
  out T extends EnumLike = EnumLike,
...
interface $ZodTransformInternals<
  O = unknown,
  I = unknown,
...
interface $ZodOptionalInternals<
  T extends SomeType = $ZodType,
...
interface $ZodNullableInternals<
  T extends SomeType = $ZodType,
...
interface $ZodDefaultInternals<
  T extends SomeType = $ZodType,
> extends $ZodTypeInternals<NoUndefined<output<T>>, input<T> | undefined> {
  def: $ZodDefaultDef<T>;
  optin: "optional";
  optout?: "optional" | undefined;
  isst: never;
...
interface $ZodPrefaultInternals<
  T extends SomeType = $ZodType,
> extends $ZodTypeInternals<NoUndefined<output<T>>, input<T> | undefined> {
...
interface $ZodNonOptionalDef<
  T extends SomeType = $ZodType,
> extends $ZodTypeDef {
  type: "nonoptional";
  innerType: T;
}
interface $ZodNonOptionalInternals<
  T extends SomeType = $ZodType,
> extends $ZodTypeInternals<NoUndefined<output<T>>, NoUndefined<input<T>>> {
...
interface $ZodSuccessInternals<
  T extends SomeType = $ZodType,
> extends $ZodTypeInternals<boolean, input<T>> {
  def: $ZodSuccessDef<T>;
  isst: never;
  optin: T["_zod"]["optin"];
  optout: "optional" | undefined;
...
interface $ZodCatchInternals<
  T extends SomeType = $ZodType,
> extends $ZodTypeInternals<output<T>, input<T>> {
  def: $ZodCatchDef<T>;
  optin: T["_zod"]["optin"];
  optout: T["_zod"]["optout"];
  isst: never;
...
> extends $ZodTypeDef {
  ...
  transform?: (
    value: output<A>,
    payload: ParsePayload<output<A>>,
  ) => MaybeAsync<input<B>>;
  /** Only defined inside $ZodCodec instances. */
  reverseTransform?: (
    value: input<B>,
    payload: ParsePayload<input<B>>,
  ) => MaybeAsync<output<A>>;
}
...
interface $ZodReadonlyInternals<
  T extends SomeType = $ZodType,
> extends $ZodTypeInternals<MakeReadonly<output<T>>, MakeReadonly<input<T>>> {
...
interface $ZodPromiseInternals<
  T extends SomeType = $ZodType,
> extends $ZodTypeInternals<Promise<output<T>>, MaybeAsync<input<T>>> {
  def: $ZodPromiseDef<T>;
  isst: never;
}
...
interface $ZodCheckLessThanInternals<
...
interface $ZodCheckMultipleOf<
  T extends number | bigint = number | bigint,
> extends $ZodCheck<T> {
  _zod: $ZodCheckMultipleOfInternals<T>;
}
declare const $ZodCheckMultipleOf: $constructor<
...
interface $ZodCheckLengthEquals<
  T extends HasLength = HasLength,
> extends $ZodCheck<T> {
...
type $ZodStringFormats =
  ...
  | "ends_with"
  | "includes";
interface $ZodCheckStringFormatDef<
...
type $ZodIssue =
  ...
  | $ZodIssueCustom;
type $ZodInternalIssue<T extends $ZodIssueBase = $ZodIssue> = T extends any
  ? RawIssue$1<T>
  : never;
...
type $ZodCheckGUIDParams = CheckStringFormatParams<
  $ZodGUID,
  "pattern" | "when"
>;
type $ZodCheckUUIDParams = CheckStringFormatParams<
  $ZodUUID,
  "pattern" | "when"
>;
...
type $ZodCheckIPv4Params = CheckStringFormatParams<
  $ZodIPv4,
  "pattern" | "when" | "version"
>;
type $ZodCheckIPv6Params = CheckStringFormatParams<
  $ZodIPv6,
  "pattern" | "when" | "version"
>;
type $ZodCheckCIDRv4Params = CheckStringFormatParams<
  $ZodCIDRv4,
  "pattern" | "when"
>;
type $ZodCheckCIDRv6Params = CheckStringFormatParams<
  $ZodCIDRv6,
  "pattern" | "when"
>;
type $ZodCheckBase64Params = CheckStringFormatParams<
  $ZodBase64,
  "pattern" | "when"
>;
type $ZodCheckBase64URLParams = CheckStringFormatParams<
  $ZodBase64URL,
  "pattern" | "when"
>;
...
type $ZodCheckISODateTimeParams = CheckStringFormatParams<
  $ZodISODateTime,
  "pattern" | "when"
>;
type $ZodCheckISODateParams = CheckStringFormatParams<
  $ZodISODate,
  "pattern" | "when"
>;
type $ZodCheckISOTimeParams = CheckStringFormatParams<
  $ZodISOTime,
  "pattern" | "when"
>;
type $ZodCheckISODurationParams = CheckStringFormatParams<
  $ZodISODuration,
  "when"
>;
type $ZodCheckNumberFormatParams = CheckParams<
  $ZodCheckNumberFormat,
  "format" | "when"
>;
type $ZodCheckLessThanParams = CheckParams<
  $ZodCheckLessThan,
  "inclusive" | "value" | "when"
>;
type $ZodCheckGreaterThanParams = CheckParams<
  $ZodCheckGreaterThan,
  "inclusive" | "value" | "when"
>;
type $ZodCheckMultipleOfParams = CheckParams<
  $ZodCheckMultipleOf,
  "value" | "when"
>;
type $ZodCheckMaxLengthParams = CheckParams<
  $ZodCheckMaxLength,
  "maximum" | "when"
>;
type $ZodCheckMinLengthParams = CheckParams<
  $ZodCheckMinLength,
  "minimum" | "when"
>;
type $ZodCheckLengthEqualsParams = CheckParams<
  $ZodCheckLengthEquals,
  "length" | "when"
>;
type $ZodCheckRegexParams = CheckParams<
  $ZodCheckRegex,
  "format" | "pattern" | "when"
>;
type $ZodCheckLowerCaseParams = CheckParams<
  $ZodCheckLowerCase,
  "format" | "when"
>;
type $ZodCheckUpperCaseParams = CheckParams<
  $ZodCheckUpperCase,
  "format" | "when"
>;
...
type ZodStandardSchemaWithJSON<T> = StandardSchemaWithJSONProps<
  input<T>,
  output<T>
>;
interface _ZodType<
...
> extends $ZodType<Output, Input, Internals> {
  ...
  refine(
    check: (arg: output<this>) => unknown | Promise<unknown>,
    params?: string | $ZodCustomParams,
  ): this;
  superRefine(
    refinement: (
      arg: output<this>,
      ctx: $RefinementCtx<output<this>>,
    ) => void | Promise<void>,
  ): this;
...
declare const ZodNumber: $constructor<ZodNumber>;
interface _ZodBoolean<
  T extends $ZodBooleanInternals = $ZodBooleanInternals,
> extends _ZodType<T> {}
...
>
  extends
    _ZodType<$ZodObjectInternals<Shape, Config>>,
...
type GameID = string;
declare const TeamCountConfigSchema: ZodUnion<
  readonly [
    ZodNumber,
    ZodLiteral<"Duos">,
    ZodLiteral<"Trios">,
    ZodLiteral<"Quads">,
    ZodLiteral<"Humans Vs Nations">,
  ]
>;
type TeamCountConfig = output<typeof TeamCountConfigSchema>;
declare const PartialGameRecordSchema: ZodObject<
  {
    info: ZodObject<
      {
        gameID: ZodString;
        lobbyCreatedAt: ZodNumber;
        config: ZodObject<
          {
            gameMap: ZodEnum<typeof GameMapType>;
            difficulty: ZodEnum<typeof Difficulty>;
            donateGold: ZodBoolean;
            donateTroops: ZodBoolean;
            ...
            instantBuild: ZodBoolean;
            randomSpawn: ZodBoolean;
            maxPlayers: ZodOptional<ZodNumber>;
            maxTimerValue: ZodOptional<ZodNumber>;
            disabledUnits: ZodOptional<ZodArray<ZodEnum<typeof UnitType>>>;
            playerTeams: ZodOptional<
              ZodUnion<
                readonly [
                  ZodNumber,
                  ZodLiteral<"Duos">,
          ...
          ZodObject<
            {
              clientID: ZodString;
              username: ZodString;
              cosmetics: ZodOptional<
                ZodObject<
                  {
                    flag: ZodOptional<ZodOptional<ZodString>>;
                    pattern: ZodOptional<
                      ZodObject<
                        {
                          name: ZodString;
                          patternData: ZodString;
                          colorPalette: ZodOptional<
                            ZodObject<
                              {
                                name: ZodString;
                                primaryColor: ZodString;
                                secondaryColor: ZodString;
                              },
                              $strip
                            >
                          >;
                ...
                >
              >;
              persistentID: ZodNullable<ZodUUID>;
              clanTag: ZodOptional<ZodString>;
              stats: ZodOptional<
                ZodObject<
                  {
                    attacks: ZodOptional<
                      ZodArray<
                        ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>
                      >
                    >;
                    betrayals: ZodOptional<
                      ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>
                    >;
                    killedAt: ZodOptional<
                      ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>
                    >;
                    conquests: ZodOptional<
                      ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>
                    >;
                    boats: ZodOptional<
                      ZodRecord<
        ...
        winner: ZodOptional<
          ZodUnion<
            readonly [
              ZodTuple<[ZodLiteral<"player">, ZodString], ZodString>,
              ZodTuple<[ZodLiteral<"team">, ZodString], ZodString>,
            ]
          >
        >;
        lobbyFillTime: ZodNumber;
      },
      $strip
    >;
    version: ZodLiteral<"v0.0.2">;
    turns: ZodArray<
      ZodObject<
        {
          turnNumber: ZodNumber;
          intents: ZodArray<
            ZodDiscriminatedUnion<
              [
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"attack">;
                    targetID: ZodNullable<ZodString>;
                    troops: ZodNullable<ZodNumber>;
                  },
                  $strip
                >,
                ZodObject<
                ...
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"mark_disconnected">;
                    isDisconnected: ZodBoolean;
                  },
                  $strip
                >,
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"boat">;
                    targetID: ZodNullable<ZodString>;
                    troops: ZodNumber;
                    dst: ZodNumber;
                    src: ZodNullable<ZodNumber>;
                  },
                  $strip
                >,
                ZodObject<
                ...
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"allianceRequest">;
                    recipient: ZodString;
                  },
                  $strip
                >,
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"allianceRequestReply">;
                    requestor: ZodString;
                    accept: ZodBoolean;
                  },
                  $strip
                ...
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"emoji">;
                    recipient: ZodUnion<
                      readonly [ZodString, ZodLiteral<"AllPlayers">]
                    >;
                    emoji: ZodNumber;
                  },
                  $strip
                ...
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"donate_gold">;
                    recipient: ZodString;
                    gold: ZodNullable<ZodNumber>;
                  },
                  $strip
                >,
                ZodObject<
                ...
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"build_unit">;
                    unit: ZodEnum<typeof UnitType>;
                    tile: ZodNumber;
                  },
                  $strip
                >,
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"upgrade_structure">;
                    unit: ZodEnum<typeof UnitType>;
                    unitId: ZodNumber;
                  },
                  $strip
                ...
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"embargo">;
                    targetID: ZodString;
                    action: ZodUnion<
                      readonly [ZodLiteral<"start">, ZodLiteral<"stop">]
                    >;
                  },
                  $strip
                >,
                ...
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"quick_chat">;
                    recipient: ZodString;
                    quickChatKey: ZodEnum<{
                      [x: string]: string;
                    }>;
                ...
                ZodObject<
                  {
                    clientID: ZodString;
                    type: ZodLiteral<"allianceExtension">;
                    recipient: ZodString;
                  },
                  $strip
                >,
...
declare const PlayerGameSchema: ZodObject<
  {
    gameId: ZodString;
    start: ZodISODateTime;
    mode: ZodEnum<typeof GameMode>;
    type: ZodEnum<typeof GameType>;
    map: ZodEnum<typeof GameMapType>;
    difficulty: ZodEnum<typeof Difficulty>;
    clientId: ZodOptional<ZodString>;
  },
  $strip
>;
type PlayerGame = output<typeof PlayerGameSchema>;
declare const PlayerProfileSchema: ZodObject<
  {
      ...
      ZodObject<
        {
          ...
          username: ZodString;
          global_name: ZodNullable<ZodString>;
          discriminator: ZodString;
        },
        $strip
      >
    >;
    ...
    >;
    stats: ZodRecord<
      ZodEnum<typeof GameType> & $partial,
      ZodRecord<
        ZodEnum<typeof GameMode> & $partial,
        ZodRecord<
          ZodEnum<typeof Difficulty> & $partial,
          ZodObject<
            {
              wins: ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>;
              losses: ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>;
              total: ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>;
              stats: ZodOptional<
                ZodObject<
                  {
                    attacks: ZodOptional<
  ...
  $strip
>;
type PlayerProfile = output<typeof PlayerProfileSchema>;
declare const ClanLeaderboardEntrySchema: ZodObject<
  {
    clanTag: ZodString;
    games: ZodNumber;
    wins: ZodNumber;
    losses: ZodNumber;
    playerSessions: ZodNumber;
    weightedWins: ZodNumber;
    weightedLosses: ZodNumber;
    weightedWLRatio: ZodNumber;
  },
  $strip
>;
type ClanLeaderboardEntry = output<typeof ClanLeaderboardEntrySchema>;
declare const ClanLeaderboardResponseSchema: ZodObject<
  {
    start: ZodISODateTime;
    end: ZodISODateTime;
    clans: ZodArray<
 ...
 */
declare function getPlayerInfo(
 ...
 */
declare function getPlayerSessions(
 ...
 */
declare function getClanSessions(
  params: GetClanSessionsParams,
): Promise<ClanSession[]>;
declare const _default: {
  getGames: typeof getGames;
  getGameInfo: typeof getGameInfo;
  getPlayerInfo: typeof getPlayerInfo;
  getPlayerSessions: typeof getPlayerSessions;
  getClanLeaderboard: typeof getClanLeaderboard;
  getClanStats: typeof getClanStats;
  getClanSessions: typeof getClanSessions;
};
