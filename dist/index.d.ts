...
type GameID = string;
declare const TeamCountConfigSchema: ZodUnion<readonly [ZodNumber, ZodLiteral<"Duos">, ZodLiteral<"Trios">, ZodLiteral<"Quads">, ZodLiteral<"Humans Vs Nations">]>;
...
declare const PartialGameRecordSchema: ZodObject<{
    info: ZodObject<{
        ...
        config: ZodObject<{
            ...
            playerTeams: ZodOptional<ZodUnion<readonly [ZodNumber, ZodLiteral<"Duos">, ZodLiteral<"Trios">, ZodLiteral<"Quads">, ZodLiteral<"Humans Vs Nations">]>>;
        }, $strip>;
        players: ZodArray<ZodObject<{
            clientID: ZodString;
            username: ZodString;
            cosmetics: ZodOptional<ZodObject<{
                flag: ZodOptional<ZodOptional<ZodString>>;
                pattern: ZodOptional<ZodObject<{
                    name: ZodString;
                    patternData: ZodString;
                    colorPalette: ZodOptional<ZodObject<{
                        name: ZodString;
                        primaryColor: ZodString;
                        secondaryColor: ZodString;
                    }, $strip>>;
                }, $strip>>;
                color: ZodOptional<ZodObject<{
                    color: ZodString;
                }, $strip>>;
            }, $strip>>;
            persistentID: ZodNullable<ZodUUID>;
            clanTag: ZodOptional<ZodString>;
            stats: ZodOptional<ZodObject<{
                attacks: ZodOptional<ZodArray<ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>>>;
                betrayals: ZodOptional<ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>>;
                killedAt: ZodOptional<ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>>;
                conquests: ZodOptional<ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>>;
                boats: ZodOptional<ZodRecord<ZodEnum<{
                    trade: "trade";
                    trans: "trans";
                }> & $partial, ZodArray<ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>>>>;
                bombs: ZodOptional<ZodRecord<ZodEnum<{
                    mirv: "mirv";
                    abomb: "abomb";
                    hbomb: "hbomb";
                    mirvw: "mirvw";
                }> & $partial, ZodArray<ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>>>>;
                gold: ZodOptional<ZodArray<ZodPipe<ZodTransform<unknown, unknown>, ZodBigInt>>>;
                units: ZodOptional<ZodRecord<ZodEnum<{
                    city: "city";
                    defp: "defp";
                    port: "port";
                    wshp: "wshp";
        ...
        duration: ZodNumber;
        num_turns: ZodNumber;
        winner: ZodOptional<ZodUnion<readonly [ZodTuple<[ZodLiteral<"player">, ZodString], ZodString>, ZodTuple<[ZodLiteral<"team">, ZodString], ZodString>]>>;
        lobbyFillTime: ZodNumber;
    }, $strip>;
    version: ZodLiteral<"v0.0.2">;
    turns: ZodArray<ZodObject<{
        turnNumber: ZodNumber;
        intents: ZodArray<ZodDiscriminatedUnion<[ZodObject<{
            clientID: ZodString;
            ...
            recipient: ZodUnion<readonly [ZodString, ZodLiteral<"AllPlayers">]>;
            emoji: ZodNumber;
        }, $strip>, ZodObject<{
            clientID: ZodString;
            ...
            targetID: ZodString;
            action: ZodUnion<readonly [ZodLiteral<"start">, ZodLiteral<"stop">]>;
        }, $strip>, ZodObject<{
            clientID: ZodString;
...
declare const PlayerProfileSchema: ZodObject<{
    ...
    stats: ZodRecord<ZodEnum<typeof GameType> & $partial, ZodRecord<ZodEnum<typeof GameMode> & $partial, ZodRecord<ZodEnum<typeof Difficulty> & $partial, ZodObject<{
